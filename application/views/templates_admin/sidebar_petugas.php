    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">LELANG.TRIANA</div>
            </a>
            ...
            <!-- <li class="nav-item active ">
                <a class="nav-link" href="<?= base_url('petugas/Data_petugas'); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>Data Petugas
                </a>
            </li> -->
            ...
            <!-- <li class="nav-item active ">
                <a class="nav-link" href="<?= base_url('petugas/laporan'); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>Laporan
                </a>
            </li> -->
            <hr class="sidebar-divider my-0">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <ul class="na navbar-nav navbar-right">
                            <?php if ($this->session->userdata('username')) { ?>
                                ...
                                <li class="ml-2"><?= anchor('dashboard/logout', 'Logout'); ?></li>
                            <?php } else { ?>
