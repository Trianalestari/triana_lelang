<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<a href="<?= base_url('petugas/data_barang/tambah_barang') ?>" 
			class="btn btn-sm btn-danger float-right">Tambahkan barang</a>
			</div>
				...
				<table class="table table-hover table-bordered">
					...
					foreach ($tb_barang as $brg) : ?>
						<tr>
							...
							<td>
								<a href="<?= base_url('petugas/data_barang/edit/' . $brg->id_barang) ?>" 
								class="btn btn-sm btn-primary">Edit</a>
								<a href="<?= base_url('petugas/data_barang/delete/' . $brg->id_barang) ?>" 
